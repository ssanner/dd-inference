//////////////////////////////////////////////////////////////////////
//
// Algebraic Decision Diagram Package (Decision Diagram Interface)
//
...
// TODO:
// -----
// - Add: Dump DD to a tree (needed to rebuild DDs after FO regression)
// - Add: verifyOrder() routine
// - Add: Implement an equals routine (different ints for AADDs can be
//                                     same function)
// - Efficiency: Need to use factory allocators... Java alloc/gc too slow
// - Efficiency: Special HashMap
//
//////////////////////////////////////////////////////////////////////
...
public abstract class DD {
    ...
    public final static int TYPE_AADDSD  = 3;
    public final static int TYPE_AADDDD  = 4;
    public final static int TYPE_AADDLD  = 5;
    public final static int TYPE_AADDSD4D  = 6;
    public final static int TYPE_AADDDD4D  = 7;
    public final static int TYPE_AADDLD4D  = 8;
    public final static int TYPE_AADDSDDT  = 9;
    public final static int TYPE_AADDDDDT  = 10;
    public final static int TYPE_AADDLDDT  = 11;
    
    // Boolean/Arithmetic operation codes
    public static final int LOG_AND       = 10;
    public static final int LOG_OR        = 11;
    public static final int EXP_SUM_LOG   = 21;
    public static final int EXP_MINUS_LOG = 22;
    ...
    // Members
    public ArrayList  _alOrder;       // list of global IDs for order
    ...
    // Build a var ADD 
    public abstract int getVarNode(int gid, double low, double high);
    ...
    // internal nodes)
    public abstract int buildDDFromUnorderedTree(ArrayList l, Map var2ID);
    
    // Build an ADD from a list with correct variable order (node is a
    // list, high comes first for internal nodes)
    public abstract int buildDDFromOrderedTree(ArrayList l, Map var2ID);
    ...
    public abstract Graph getGraph(int id, Map id2var);
