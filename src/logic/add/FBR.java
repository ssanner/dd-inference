...
public class FBR {
	...
	public Object applyInt(Object a1, Object a2, int op) {
		...
		if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
			...
			return new Integer(_context.applyInt(i1.intValue(), i2.intValue(),
					op));
	...
	public double compareEnum(Object id1, Object id2) {
		...
		if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
			...
			return DD.CompareEnum(_context, i1.intValue(), _context,
					i2.intValue());
	...
	public static double CompareEnum(FBR f1, Object n1, FBR f2, Object n2) {

		if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
			// Handle Integer
			Integer i1 = (Integer) n1;
			Integer i2 = (Integer) n2;
			return DD.CompareEnum(f1._context, i1.intValue(), f2._context,
					i2.intValue());
