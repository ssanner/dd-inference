...
//	 **/
	public static void main(String args[]) {
		...
		//mdp[2] = new MDP(filename, DD.TYPE_AADD); names[2] = "DAADD";
//		mdp[2] = new MDP(filename, DD.TYPE_AADDSD); names[2] = "AADD-sd";
//		mdp[2] = new MDP(filename, DD.TYPE_AADDDD); names[2] = "AADD-dd";
//		mdp[3] = new MDP(filename, DD.TYPE_AADDLD); names[3] = "AADD-ld";
